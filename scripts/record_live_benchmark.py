...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    private = {
        ...
        "metrics": {
            ...
            "p2p_role": status.get("p2pRole"),
            "encode_profile": settings.get("encodeProfile"),
            ...
            "vaapi_async_depth": live.get("async_depth")
            or settings.get("vaapiAsyncDepth"),
        ...
        json.dumps(
            {
                ...
                "sink": safe_sink,
                "encode": {
                    "profile": settings.get("encodeProfile"),
                    "content": settings.get("castPreset"),
                    "engine": settings.get("captureEncode"),
                    ...
                    "quality": live.get("quality") or settings.get("vaapiQuality"),
                    "async_depth": live.get("async_depth")
                    or settings.get("vaapiAsyncDepth"),
                },
                "tx_mbps_max": tx_profile.get("tx_mbps_max"),
